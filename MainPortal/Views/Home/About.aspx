<%@ Page Language="VB" MasterPageFile="~/Views/Shared/Anaget.Master" Inherits="System.Web.Mvc.ViewPage" %>
<asp:Content ID="aboutTitle" ContentPlaceHolderID="TitleContent" runat="server">
	メインポータル - Anaget.com
</asp:Content>

<asp:Content ID="MainPortalContent" ContentPlaceHolderID="MainContent" runat="server">
...
<%-- Setting Hide Start --%>                  
                    ...
                    <script type="text/javascript">
                        function Initialize() {
                            var navbar = document.getElementById("ace-settings-navbar");
                            navbar.checked = true;
                            var sidebar = document.getElementById("ace-settings-sidebar");
